                            ...
                            <tbody>
                                @foreach ($vendedores as $vendedor)
                                    <tr>
                                        ...
                                        <td>{{ucwords(strtolower($vendedor->persona->nombre))}} {{ ucwords(strtolower($vendedor->persona->apellido))}}</td>
                                        <td>{{ucwords(strtolower($vendedor->cargo->nombre))}}</td>
                                            <td class="text-center">
                                                <button class="btn btn-warning btn-sm" wire:click="edit({{ $vendedor->id }})"><i class="fas fa-pencil-alt"></i></button>
                                                @if ($vendedor->estado == 1)
                                                    <button class="btn btn-danger btn-sm" wire:click="destroy({{ $vendedor->id }})"><i class="fas fa-trash"></i></button>
                                                @else
                                                    <button class="btn btn-primary btn-sm" wire:click="destroy({{ $vendedor->id }})"><i class="fas fa-history"></i></button>
                                                @endif
                                            </td>
                                    </tr>
                                @endforeach
                                ...
                                <form wire:submit="created">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control mt-2" wire:model="vendedor.id_cargo" required>
